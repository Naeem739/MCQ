      ...
      <div className="mx-auto max-w-4xl px-4 py-10">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-600">Upload CSV and manage quizzes.</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <form action={adminLogout}>
              <button className="rounded-2xl bg-zinc-900 px-4 py-2 text-sm font-semibold text-white hover:bg-zinc-800">
                Logout
              </button>
            </form>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-zinc-900">Upload MCQ CSV</h2>
            <p className="mt-1 text-sm text-zinc-600">
              Columns: <span className="font-mono">question</span>,{" "}
              <span className="font-mono">optionA</span>.., <span className="font-mono">answer</span>
              , optional <span className="font-mono">hint</span>.
            </p>
            <div className="mt-4">
          ...
          <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-zinc-900">Your quizzes</h2>
            <p className="mt-1 text-sm text-zinc-600">
